...
insert into paciente (id, apellido, dni, nombre,usuario_id) values (1,"ana", 111, "alan",1), (2,"brado", 222, "alan",2);
...
insert into usuario(email,password,rol) values ('a@a.com','123456','paciente'),('b@b.com','123456','recepcionista');
