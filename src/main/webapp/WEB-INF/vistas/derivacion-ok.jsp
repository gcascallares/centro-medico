...
<<<<<<< HEAD
      ...
      <div id="content-wrapper">
    	...
    	<div class="card">
		  <div class="card-body">
		    <i class="fas fa-user-md"></i> <span>  Medico Id: ${derivacion.medicoId}</span> 
		  </div>
		</div>
		...
		<div class="card">
		  <div class="card-body">
		    <i class="fas fa-briefcase-medical"></i> <span>  Especialidad Id: ${derivacion.especialidadId}</span> 
		  </div>
		</div>
		...
		<div class="card">
		  <div class="card-body">
		    <i class="far fa-clock"></i> <span>  Horario: ${derivacion.horario}</span>
		  </div>
		</div>
		...
		<div class="card">
		  <div class="card-body">
		    <i class="fas fa-calendar-alt"></i><span>  Fecha: ${derivacion.fecha}</span>
		  </div>
		</div>
