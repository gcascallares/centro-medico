          ...
          <ol class="breadcrumb">
			...
			<c:if test="${fn:length(listaTurnosProxDiaLaboral) == 0}">
			   ...
			   <div class="card w-10 mx-auto mt-2 mb-2">
			   						...
			   						<a href="${context}/medico/mostrarhistoriaclinica/${Turnos.paciente.id}/${medicoId}/${consultorioId}"><h5 class="card-header">Paciente: ${Turnos.paciente.nombre} ${Turnos.paciente.apellido}</h5></a>
			   						 <div class="card-body">
